// $Id: CBC.java,v 1.5 1997/12/09 05:14:36 raif Exp $
//
// $Log: CBC.java,v $
...
//...........................................................................
    ...
    protected int engineUpdate(byte[] in, int inOffset, int inLen, byte[] out,
        ...
        switch (getState()) {
            case ENCRYPT:
                for (int i = 0; i < inLen; ) ivBlock[i++] ^= in[inOffset++];
//                cipher.crypt(ivBlock, 0, inLen, ivBlock, 0);
                cipher.update(ivBlock, 0, inLen, ivBlock, 0);
                System.arraycopy(ivBlock, 0, out, outOffset, inLen);
                break;

            case DECRYPT:
//                cipher.crypt(in, inOffset, inLen, xorBlock, 0);
                cipher.update(in, inOffset, inLen, xorBlock, 0);
                for (int i = 0; i < inLen; i++)
                    out[i+outOffset] = (byte) (xorBlock[i] ^ ivBlock[i]);
//                System.arraycopy(xorBlock, 0, ivBlock, 0, inLen);
                System.arraycopy(in, inOffset, ivBlock, 0, inLen);
                break;
