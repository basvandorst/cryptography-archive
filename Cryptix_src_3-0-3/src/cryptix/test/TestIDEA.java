// $Id: TestIDEA.java,v 1.3 1997/11/22 07:05:41 raif Exp $
//
// $Log: TestIDEA.java,v $
...
//...........................................................................
    ...
    public TestIDEA () {
        try {
            ...
            test1(alg, System.out, testData1);

            System.out.println("\n*** IDEA in CFB mode:\n");
            alg = Cipher.getInstance("IDEA/CFB", "Cryptix");
            test2(alg, System.out, testData2);
...
// Test code. From the Cryptix source files
//............................................................................
    
    public static final void main(String[] args) {
        System.out.println("*** IDEA:\n");
        TestIDEA x = new TestIDEA();
    }

    private void test1 (Cipher alg, java.io.PrintStream out, String[][] data)
    throws Exception {
        byte[] ect, dct;
        String a, b;
...
out.println("...");
            ...
            out.println("plain:" + data[i][1] + " enc:" + a + " calc:" + data[i][2]);
            if (a.equals(data[i][2]))
                out.println( " ********* IDEA ENC GOOD ********* " );
            else
                out.println(" ********* IDEA ENC FAILED ********* ");
        
            out.println("  enc:" + Hex.toString(ect) + " dec:" + b + " calc:" +
                data[i][1]);
            if (b.equals(data[i][1]))
                out.println(" ********* IDEA DEC GOOD ********* ");
            else
                out.println(" ********* IDEA DEC FAILED ********* ");
        }
    }
    
    private void test2 (Cipher alg, java.io.PrintStream out, String[][] data)
    throws Exception {
        byte[] pt, ect, dct;
...
out.println("...");
            ...
            out.println("plain:" + Hex.toString(pt) +
                " enc:" + Hex.toString(ect) +
                " dec:" + Hex.toString(dct));
            if (ArrayUtil.areEqual(pt, dct))
                out.println(" ********* IDEA FEEDBACK GOOD ********* ");
            else
                out.println(" ********* IDEA FEEDBACK FAILED ********* ");
        }
    }
}
