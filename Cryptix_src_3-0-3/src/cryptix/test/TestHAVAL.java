// $Id: TestHAVAL.java,v 1.3 1997/11/22 07:05:40 raif Exp $
//
...
import cryptix.provider.md.HAVAL;
...
//................................................................................
    ...
    private TestHAVAL () {
        try {
            HAVAL alg = new HAVAL();
            test(alg, System.out, testData1);
            System.out.println("--------------------------------------------");
            test(alg, System.out, testData2);
            System.out.println("--------------------------------------------");
            test(alg, System.out, testData3);
            System.out.println("--------------------------------------------");
        } catch (Throwable t) {
            t.printStackTrace();
        }
...
//................................................................................
    ...
    public static final void main (String[] args) {
        ...
        TestHAVAL x = new TestHAVAL();
    }
    
    private void test (HAVAL alg, java.io.PrintStream out, String[][] data)
    throws Exception {

        byte[] x;
        String a;
        for (int i = 0; i < data.length; i++) {
            alg.setPasses(Integer.valueOf(data[i][0]).intValue());
            alg.setBitLength(Integer.valueOf(data[i][1]).intValue());
            if (i != 6)
            ...
            out.print(a.equals(data[i][3]) ? "GOOD" : "FAILED");
            out.println(" *********\n...");
        }
    }
}
