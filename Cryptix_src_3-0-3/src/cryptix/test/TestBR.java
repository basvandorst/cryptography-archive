// $Id: TestBR.java,v 1.4 1998/01/12 04:10:39 hopwood Exp $
//
// $Log: TestBR.java,v $
...
extends BaseTest
{
    ...
    protected void engineTest() throws Exception {
        ...
        try {
            a.atRandom();
            out.println("About to serialize A and B to './t.tmp'...");
            out.println("Register A (random value): " + a);
            out.println("Register B: " + b);
...
//            b.reset();        out.println("Register B: " + b);
            ...
            out.println("About to deserialize A and B from './t.tmp'...");
            ...
            fail("Exception during serialization test");
            e.printStackTrace();
        }
