// $Id: TestRIPEMD128.java,v 1.4 1998/01/05 03:43:29 iang Exp $
//
...
import cryptix.provider.md.RIPEMD128;
...
{
    public static final void main (String[] args) { TestRIPEMD128 x = new TestRIPEMD128(); }


    public TestRIPEMD128 () {
        System.out.println("*** RIPEMD-128:\n");
        String[][] data = {
            //    data, md
            {"",
