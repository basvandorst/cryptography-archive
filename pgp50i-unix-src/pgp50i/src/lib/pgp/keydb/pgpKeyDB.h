 ...
 *
 * $Id: pgpKeyDB.h,v 1.72.2.12.2.4 1997/08/18 22:37:38 quark Exp $
 */
...
typedef enum PGPPrefNameNumber_ {
	...
	kPGPPrefOutputPrimaryFD,
	kPGPPrefOutputInformationFD,
	kPGPPrefOutputInteractionFD,
	kPGPPrefOutputWarningFD,
	kPGPPrefOutputErrorFD,
	kPGPPrefOutputStatusFD,
...
typedef enum PGPPrefNameBoolean_ {
	...
	kPGPPrefGetNotFoundKeyFiles,
	kPGPPrefFailOnInvalidKeys,
	kPGPPrefBoolLast
} PGPPrefNameBoolean;
