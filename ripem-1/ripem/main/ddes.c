...
static void scrunch P((unsigned char *, unsigned long *));
static void unscrun P((unsigned long *, unsigned char *));
static void desfunc P((unsigned long *, unsigned long *));
static void cookey P((unsigned long *));
...
{
	register unsigned long *right, *leftt, *l1, swap;
	unsigned long bufL[2], bufR[2];
	
	leftt = bufL, right = bufR;
	l1 = &bufL[1];
	scrunch(from, leftt);
 ...
 *
 * ddes V5.06 rwo 9205.23 10:12 Graven Imagery
 **********************************************************/
