# PGPdiskDrvDebug.mak - makefile for port driver PGPdisk
...
USER_LIB		= Llmul.obj Llshl.obj Ullrem.obj Ulldiv.obj Ullshr.obj

PGPDIRS			= /I "..\..\..\..\..\libs\pfl\common" \
					/I "..\..\..\..\..\libs\pfl\win32" /I "..\FakeSource" \
					/I "..\..\Shared" /I "..\..\Encryption" \
					/I "$(DEVSTUDIO)\VC\Include"

COPTFLAGS	= 
OBJPATH		= ../Debug/

XFLAGS = $(PGPDIRS) /W3 /WX /DUCHAR_MAX=0xFF /DUSHRT_MAX=0xFFFF \
			/DULONG_MAX=0xFFFFFFFF /DINT_MAX=0xFFFFFFFF /D_CRT_ASSERT=0 \
			/D_MSC_VER=5000 /DDEBUG /DPGP_DEBUG=1 /DPGPDISK_95DRIVER \
			/DPGP_INTEL /DPGP_WIN32 /DUNFINISHED_CODE_ALLOWED
