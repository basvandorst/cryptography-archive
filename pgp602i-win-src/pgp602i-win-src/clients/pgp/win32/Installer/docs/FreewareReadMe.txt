...
regarding PGP 6.0.2. Network Associates strongly 
...
An internal security review of previous versions of
PGPdisk for Windows revealed a serious security flaw. 
The version of PGPdisk that accompanies this release
of PGP (6.0.2) repairs this problem.  After you install
PGP 6.0.2 and reboot your machine, the PGPdisk Conversion
Wizard will scan your machine for any existing PGPdisk 
volumes so that you may upgrade them.  During this 
conversion, you will lose any alternate passphrases and 
public keys (with the exception of ADKs) associated with 
the volume.

You must use the master passphrase to convert each volume.

PGPdisk will continue to automatically upgrade older 
volumes as you attempt to use them (this enables you 
to repair volumes on external media, network drives, backups, 
and so on, as you need to).  We strongly recommend that 
you update all your PGPdisk volumes to the new version 
immediately.  

Instructions on how to run the Conversion Wizard are 
...
If you are interested in using or generating 
RSA keys, please review the following information 
to determine which version of PGP 6.0.2 you need:
...
Use existing RSA keys    PGP for Personal Privacy RSA Add-on
                         PGP Desktop Security RSA Add-on 

Generate new RSA keys    PGP for Personal Privacy RSA Add-on
                         PGP Desktop Security RSA Add-on
                                                             

*** Note that you cannot generate RSA keys using PGP for 
Personal Privacy and you cannot use existing RSA keys without 
the RSA Add-on.  
...
PGPdisk volumes created with versions of PGPdisk prior to 
version 6.0.2 are not secure. Network Associates strongly 
recommends that you upgrade all of your PGPdisk volumes 
created with earlier versions of PGPdisk to version 6.0.2. 
All PGPdisk volumes must be converted to this new format 
to ensure that your PGPdisk volumes are secure.

PGP version 6.0.2 includes the PGPdisk Conversion Wizard, 
which converts earlier versions of PGPdisk volumes to a 
