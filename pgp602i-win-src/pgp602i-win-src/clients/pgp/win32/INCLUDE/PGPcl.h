/*____________________________________________________________________________
	...
	$Id: PGPcl.h,v 1.43.2.1 1998/09/28 19:43:29 wjb Exp $
____________________________________________________________________________*/
...
#define PGPCL_KEYSERVERPREFS		3
#define PGPCL_ADVANCEDPREFS			4
...
PGPError PGPclExport 
PGPclQueryAddKeys (PGPContextRef	Context,
...
PGPError PGPclExport 
PGPclSelectKeys (PGPContextRef		Context,
				   PGPtlsContextRef	tlsContext,
				   HWND				hWndParent, 
				   LPSTR			pszPrompt,
