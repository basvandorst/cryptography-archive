/*____________________________________________________________________________
	...
	$Id: PGPRecipientDialog.cpp,v 1.29.2.1.2.1 1998/11/12 03:24:19 heller Exp $
____________________________________________________________________________*/
	...
	PGPUserValue 		userValue)
{
	...
	if( strIndex != 0 )
	{
		...
		LoadString(g_hInst, IDS_RECIPIENTWARNING, StrRes, sizeof(StrRes));
					...
					const PGPKeyID	*keyID, char keyIDString[256])
{
	...
	if( IsntPGPError( err ) )
	{
		...
		LoadString(g_hInst, IDS_UNKNOWNKEYIDSTR, pString, sizeof(pString));
