 ...
 */
public class DEAL_Properties // implicit no-argument constructor
{
...
//...........................................................................
    ...
    static final String ALGORITHM = "DEAL";
    static final double VERSION = 0.1;
    static final String FULL_NAME = ALGORITHM + " ver. " + VERSION;
    static final String NAME = "DEAL_Properties";

    static final Properties properties = new Properties();

    /** Default properties in case .properties file was not found. */
    private static final String[][] DEFAULT_PROPERTIES = {
        {"Trace.DEAL_Algorithm",       "true"},
        {"Trace.DES_Algorithm",        "true"},
        {"Debug.Level.*",              "1"},
        {"Debug.Level.DEAL_Algorithm", "9"},
        {"Debug.Level.DES_Algorithm",  "9"}
    };

    static {
if (GLOBAL_DEBUG) System.err.println(">>> " + NAME + ": Looking for " + ALGORITHM + " properties");
        String it = ALGORITHM + ".properties";
        InputStream is = DEAL_Properties.class.getResourceAsStream(it);
        boolean ok = is != null;
        if (ok)
            try {
                properties.load(is);
