 ...
 *
 * $Id: pgpCharMap.c,v 1.1.2.1 1997/06/07 09:50:00 mhw Exp $
 */
...
208, 209, 210, 211, 212, 123, 214, 215, 216, 217, 218, 219, 220, 221, 222, 223,
             ...
             byte const **toLocalP, byte const **toLatin1P)
{
        ...
        return PGPERR_CHARMAP_UNKNOWN;
}

void
pgpCharmapConvert (byte const *input, size_t inlen, byte *output,
                   byte const *charmap)
{
        while (inlen--)
