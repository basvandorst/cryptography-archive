...
//
//
//	$Id: TreeList.h,v 1.3 1997/05/09 15:42:17 pbj Exp $
//
/*
...
#define TreeList_IterateSelected(hwnd, proc) \
    (HTLITEM)SNDMSG((hwnd), TLM_ITERATESELECTED, 0, (LPARAM)(proc))
...
typedef struct _NM_TREELISTA {
    ...
    POINT       ptDrag;
} NM_TREELISTA, FAR *LPNM_TREELISTA;

typedef struct _NM_TREELISTW {
    NMHDR       hdr;
    UINT        flags;
	UINT		index;
    TL_TREEITEMW    itemOld;
    TL_TREEITEMW    itemNew;
    POINT       ptDrag;
} NM_TREELISTW, FAR *LPNM_TREELISTW;

#ifdef UNICODE
#define  NM_TREELIST            NM_TREELISTW
#define  LPNM_TREELIST          LPNM_TREELISTW
#else
#define  NM_TREELIST            NM_TREELISTA
#define  LPNM_TREELIST          LPNM_TREELISTA
#endif

#define TLN_SELCHANGEDA         (TLN_FIRST-2)
#define TLN_SELCHANGEDW         (TLN_FIRST-51)
...
#define TLN_HEADERCLICKEDA      (TLN_FIRST-3)
#define TLN_HEADERCLICKEDW      (TLN_FIRST-52)

#define TLN_BEGINDRAGA          (TLN_FIRST-7)
#define TLN_BEGINDRAGW          (TLN_FIRST-56)
...
#ifdef UNICODE
#define TLN_SELCHANGED          TLN_SELCHANGEDW
#define TLN_HEADERCLICKED		TLN_HEADERCLICKEDW
#define TLN_BEGINDRAG           TLN_BEGINDRAGW
#else
#define TLN_SELCHANGED          TLN_SELCHANGEDA
#define TLN_HEADERCLICKED		TLN_HEADERCLICKEDA
#define TLN_BEGINDRAG           TLN_BEGINDRAGA
#endif
...
#endif
#define TreeList_SetListItem(hwnd, pitem)   \
	(int)SNDMSG((hwnd), TLM_SETLISTITEM, 0, \
