...
#ifndef _NewsTreedefs_h
#define _NewsTreedefs_h 1

#include "NewsTree.h"

// equality operator
#ifndef NewsTreeEQ
#define NewsTreeEQ(a, b)  ( (!strcmp((a)->tree_name(), (b)->tree_name())) ? 1 : 0 )
#endif

// less-than-or-equal
#ifndef NewsTreeLE
#define NewsTreeLE(a, b)  ((a) <= (b))
#endif

// comparison : less-than -> < 0; equal -> 0; greater-than -> > 0
#ifndef NewsTreeCMP
#define NewsTreeCMP(a, b) ( strcmp((a)->tree_name(), (b)->tree_name()) )
#endif

// hash function
#ifndef NewsTreeHASH
extern unsigned int hash(NewsTree&);
#define NewsTreeHASH(x)  hash(x)
#endif
