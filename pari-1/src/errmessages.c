...
{  
  ...
  "not a number field in an ideal-related function",
  ...
  "polynomial not in Z[X] in initalg0",
  "not a monic polynomial in initalg0",
  ...
  "buchxxx is not available in library mode unless you add buch.o\nto the library files",
