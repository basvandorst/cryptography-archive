...
printf("\
Secure Drive Find Partition Utility Version 1.3c \n\
\n\
...
if(tsr_wrong_version)
 {
  printf ("ERROR: Wrong Version (not 1.3C) of SECTSR is Installed\n");
  exit(1);
 }
