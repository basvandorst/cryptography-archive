/*
 * $Id: bni64.h,v 1.1 1997/06/20 23:47:03 hal Exp $
 */
...
#ifndef bniExpMod_64
int bniExpMod_64(BNWORD64 *result, BNWORD64 const *n, unsigned nlen,
	BNWORD64 const *exp, unsigned elen, BNWORD64 *mod, unsigned mlen);
#endif
#ifndef bniDoubleExpMod_64
int bniDoubleExpMod_64(BNWORD64 *result,
...
int bniTwoExpMod_64(BNWORD64 *n, BNWORD64 const *exp, unsigned elen,
	BNWORD64 *mod, unsigned mlen);
#endif
#ifndef bniGcd_64
...
#endif
#ifndef bniInv_64
int bniInv_64(BNWORD64 *a, unsigned alen, BNWORD64 const *mod, unsigned mlen);
#endif
