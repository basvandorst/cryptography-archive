...
README file for PGP 5.5 platform-independent source code release
================================================================
...
archive only contains the platform independent parts of the source code.
In order to compile a PGP 5.5 executable for your platform, you will
also need the platform specific sources, which are distributed in
separate archives. These archives can be downloaded via anonymous FTP
from:
