Friday, September 23, 1994 17:53 EST
...
-- New features:
        ...
        - all Mail-related menu items are greyed if mail is disabled (jcooper)
        ...
        selectable from its alt-space system menu (jcooper)
...
-- Bug fixes:
        ...
        - resized some dialog text items to avoid font clipping (jcooper)

        - will not allow attachment generation if decode session active (jcooper)
        ...
        - DEF file now properly exports _all_ callback functions (jcooper)
