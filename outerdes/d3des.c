...
static void scrunch(unsigned char *, UINT32 *);
static void unscrun(UINT32 *, unsigned char *);
static void desfunc(UINT32 *, UINT32 *);
static void cookey(UINT32 *);

static UINT32 KnL[32] = { 0L };
static UINT32 KnR[32] = { 0L };
static UINT32 Kn3[32] = { 0L };
...
register UINT32 *raw1;
{
   register UINT32 *cook, *raw0;
   UINT32 dough[32];
   register int i;
...
void cpkey(into)
register UINT32 *into;
{
   register UINT32 *from, *endp;
...
void usekey(from)
register UINT32 *from;
{
   register UINT32 *to, *endp;
...
register UINT32 *block, *keys;
{
   register UINT32 fval, work, right, leftt;
   register int round;
...
void cp2key(into)
register UINT32 *into; /* UINT32[64] */
{
   register UINT32 *from, *endp;
...
register UINT32 *from; /* UINT32[64] */
{
   register UINT32 *to, *endp;
...
void cp3key(into)
register UINT32 *into; /* UINT32[96] */
{
   register UINT32 *from, *endp;
...
void use3key(from)
register UINT32 *from; /* UINT32[96] */
{
   register UINT32 *to, *endp;
