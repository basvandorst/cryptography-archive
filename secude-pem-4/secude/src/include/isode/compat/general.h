...
/* 
 * $Header: /home/isode-consortium/isode/src/h/compat/RCS/general.h,v 10.0 1993/02/18 20:24:54 awy Rel $
 *
 *
 * $Log: general.h,v $
 * Revision 10.0  1993/02/18  20:24:54  awy
 * Release IC-R1
 *
 */
...
/* 
 *
 * This header file has been slightly modified in order to incorporate some SecuDE-specific
 * features.
 *
 */
...
#if defined(SVR4) || defined (__NeXT__) || defined(__STDC__)
#include <stdio.h>
#include <stdlib.h>
...
#if !(defined(__STDC__) && defined(__GNUC__) && defined(mips) && defined(ultrix)) && !defined(__HP__)
char   *sprintf ();
#endif
#else
int     sprintf ();
