...
/* 
 * $Header: /home/isode-consortium/isode/src/h/ul/RCS/ssap.h,v 10.0 1993/02/18 20:22:46 awy Rel $
 *
 *
 * $Log: ssap.h,v $
 * Revision 10.0  1993/02/18  20:22:46  awy
 * Release IC-R1
 *
 */
...
struct SSAPabort {		/* S-{U,P}-ABORT.INDICATION */
    int	    sa_peer;		/* T   = S-U-ABORT.INDICATION:
				   ...
				   NIL = S-P-ABORT.INDICATION:
					     ...
					     sa_prdata/sa_cc contains diagnostics */
