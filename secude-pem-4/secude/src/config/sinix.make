...
#
#    Template of CONFIG.make for SINIX
#
...
DSINIX      = -DSINIX # SAG: flag for SINIX
...
DFLAGS      = $(DSCA) $(DSINIX)
IUCB        = -I/usr/ucbinclude # SAG: necessary for SINIX
IFLAGS      = -I/usr/include -I$(INCL) $(INCLISODE) $(IUCB) $(ISCA)  
#AFLAGS      = -g
AFLAGS      = -s
CFLAGS	    = $(OPT) $(DFLAGS) $(IFLAGS)
LFLAGS      = $(AFLAGS) $(LDL)
ARFLAGS     = ruv
BINDIR      = $(DD)../../bin
...
LSECUDE     = -lsecude
LM          = -lm -lx -lmalloc # SAG: -lx and -lmalloc necessary for SINIX
LIB         = $(LSECUDE) $(LX500) $(LISODE) $(LM) 
VERSION     = 4.3
...
#
# If you have already an ICR1 installation on your system, you
...
# directories (see below) without complete ICR1 installation.
#
...
# to libsecude.so.42.1. Version number 42 indicates SecuDE 4.2.
# Otherwise, set LIBSECUDESO to static.
#
LIBSECUDESO = static
#LIBSECUDESO  = libsecude.so.42.1
#SL_OPTIONS = -assert pure-text
#
#-----------------------------------------------------------------------
