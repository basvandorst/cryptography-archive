...
#
#    Template of CONFIG.make for HP 9000/HP-UX
#
...
LM          = -lm
LDBM        = -ldbm
LIB         = $(LSECUDE) $(LISODE) $(LSECUDE) $(LDBM) $(LM)
VERSION     = 4.3
...
#
DX500   = -DX500
LISODE  = -L/usr/isode/lib -lisode  # if DX500 is set, you need LISODE, too
#DISODE  =
...
ICINCLPATH = /usr/isode/include/isode
...
#----------- SecTool for OpenWindows3/XView3(tm) -----------------------
# You need X11R4, OpenWindows3, and XView3 libraries.

#DOWSECTOOL = -DOWSECTOOL
