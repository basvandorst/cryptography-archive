...
#
#    Template of CONFIG.make for AIX
#
...
LBSD	    = -lbsd
LDBM        =
LIB         = $(LSECUDE) $(LISODE) $(LDBM) $(LM) $(LBSD)
VERSION     = 4.3
...
#
#DX500   = -DX500
#LISODE  = -L/vol/local/isode/lib -lisode
#DISODE  =
...
#ICINCLPATH = /vol/local/isode/include/isode
#
#-----------------------------------------------------------------------
