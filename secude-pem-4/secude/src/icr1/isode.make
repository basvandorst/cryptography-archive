...
IFLAGS      = -I$(INCL) $(INCLISODE)
INCLISODE   = -I$(DD)../include/isode -I$(DD)../include/isode/pepsy
DFLAGS      =
...
OBJS    = pe_cpy.o pe_alloc.o pe_free.o pe_error.o pe2ps.o pe2pl.o qbuf2pe_f.o \
	  ps_alloc.o ps_free.o ps_get_abs.o ps_error.o ps_prime.o ps2pe.o ps_io.o \
          ...
          bitstr2strb.o strb2bitstr.o bit_ops.o qb_free.o str2qb.o qb2str.o utils.o pl_tables.o \
          UNIV_tables.o asprintf.o rcmd_srch.o serror.o smalloc.o py_advise.o
