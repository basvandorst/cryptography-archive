...
/*-----------------------------------------------------------------------*/
/* FILE  pem_init.c                                                      */
/* Initialization of global variables of PEM-IF                          */
/*-----------------------------------------------------------------------*/
...
char    pem_insert_cert, pem_option_r, pem_option_K, pem_cert_num = 127;
char    pem_enter_certificate_into_pklist;
char    pem_enter_issuer_certificate_into_pklist = 0;
