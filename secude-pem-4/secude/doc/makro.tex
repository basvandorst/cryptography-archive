...
\def\secudetitlepage#1#2{
        ...
        \date{
                \today \\ [1cm]
                {\normalsize Copyright \copyright 1994 by Gesellschaft f{\"u}r Mathematik und Datenverarbeitung (GMD)}
        }
        \nopagenumbering
        \maketitle
        \parindent0em
...
\def\conditions{
        Copyright \copyright Gesellschaft f{\"u}r Mathematik und Datenverarbeitung (GMD), 1990 - 1994
        \\ [1cm]
        {\footnotesize
...
\def\preface{
	...
	\\ [1em]
        ...
        \\ [1em]
        This release contains technology from ISODE Consortium Limited, which
        is copyright ISODE Consortium Limited.  ISODE Consortium Limited has
        given GMD permission to distribute this technology with this SECUDE release.
        ISODE Consortium Limited has granted GMD the right to allow any
        organisation to incorporate this technology into products or to make
        other use of the technology without payment of royalty to ISODE
        Consortium Limited provided that this technology is used only in 
        conjunction with the SECUDE release.
 
        Any other usage requires a licence from ISODE Consortium Limited.  
 
        No Warranty is given by ISODE Consortium Limited.   ISODE Consortium
        Limited will not enter into any discussions or agreements relating to
        use of its technology in this context.   
  
        Copyright \copyright ISODE Consortium Limited 1993-94
        \newpage
        ...
        \parbe {
                Internet-Address: \\
                {\small schneider@darmstadt.gmd.de} \\ [1ex]
                X.400-Address: \\
                {\small C=DE; ADMD=D400; PRMD=GMD; OU=Darmstadt; S=Schneider}
        }
	\newpage
