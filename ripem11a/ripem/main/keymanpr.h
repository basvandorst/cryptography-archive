...
/* keyman.c */
char *GetPublicKey P((char *user , TypKeySource *source , R_RSA_PUBLIC_KEY *key , BOOL *found ));
char *GetPublicKeyList P((TypList *userList , TypKeySource *pubKeySource ));
...
char *GetUserRecordFromFile P((char *user , TypFile *fileptr , unsigned int maxBytes , char *userRec , BOOL *found ));
