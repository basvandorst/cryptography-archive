...
/* crackhed.c */
char *CrackHeader P((FILE *stream , BOOL prependHeaders, TypList *headerList, TypList *userList , TypMsgInfo *msgInfo ));
char *DoHeaderLine P((char *ext_line , TypList *userList , TypMsgInfo *msgInfo ));
