From msuinfo!agate!usenet.ins.cwru.edu!magnus.acs.ohio-state.edu!cis.ohio-state.edu!slayer.mit.edu!jsc Tue Apr  5 18:02:11 1994
Path: msuinfo!agate!usenet.ins.cwru.edu!magnus.acs.ohio-state.edu!cis.ohio-state.edu!slayer.mit.edu!jsc
From: jsc@slayer.mit.edu
Newsgroups: gnu.emacs.sources
Subject: mailcrypt v1.5 (support for PGP and RIPEM for mail modes)
Date: 2 Apr 1994 13:10:29 -0500
Organization: Source only  Discussion and requests in gnu.emacs.help.
Lines: 867
Sender: daemon@cis.ohio-state.edu
Distribution: gnu
Message-ID: <199404021648.AA01245@slayer.mit.edu>
Reply-To: jsc@mit.edu


This is mailcrypt v1.5. Changes from v1.4 include mh-e support, better
non-replacement viewing of messages, and various bug fixes.
