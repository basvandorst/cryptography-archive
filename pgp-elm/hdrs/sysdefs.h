...
#define DEFAULT_DOMAIN  ".lancs.ac.uk"  /* if mydomain file is missing */
...
#define system_text_file        "/usr/local/lib/aliases.text"
#define system_data_file        "/usr/local/lib/aliases"
#define system_rc_file		"/usr/local/lib/elm.rc"
...
#define default_editor	"/uol/bin/ue "
#define mailhome	"/usr/spool/mail/"

#define default_shell	"/uol/bin/tcsh"
