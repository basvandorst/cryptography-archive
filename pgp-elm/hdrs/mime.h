 ...
 ******************************************************************************
 * $Log: mime.h,v $
 * Revision 5.4  1994/01/08  00:34:54  Mic
 * Added defines for MINE pgp headers.  (uses X- since they are not official
 * yet)
...
#define MIME_HEADER_PGP_PUBLIC_KEY "application/X-pgp-public-key;"
#define MIME_HEADER_PGP_MESSAGE "application/X-pgp-message;"
