 ...
 *******************************************************************************
 * $Log: remail.c,v $
 * Revision 5.14  1994/01/08  00:22:44  Mic
 * Uses the pgp_copy_message() to enable decoding of messages so you can
...
remail()
{
	...
	pgp_copy_message("", mailfd, CM_REMOTE | CM_MMDF_HEAD | CM_REMAIL);
