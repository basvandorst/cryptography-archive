...
#ifndef	lint
static char desUtil_cRcs[] = "$Id: desUtil.c,v 1.13 1992/05/15 07:58:20 how E $";
#endif
...
register byte * k;
{
	...
	/* the inclusion of constant bits is inspired by ideas and code
	 * from Richard Outerbridge;  see desCode.h for how they're used */
	n = 16;
	k = rotors;
	do {
		w   = (b1[k[ 0   ]] | b0[k[ 1   ]]) << 4;
