...
#ifdef ANSI_C
  static void Idea_Crypt (Idea_Data dataIn, Idea_Data dataOut, Idea_Key key)
#else
...
#ifdef ANSI_C
  static void Idea_InvertKey (Idea_Key key, Idea_Key invKey)
#else
...
#ifdef ANSI_C
  static void Idea_ExpandUserKey (Idea_UserKey userKey, Idea_Key key)
#else
