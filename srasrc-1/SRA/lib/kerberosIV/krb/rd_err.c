/*
 * $Source: /usr/src/kerberosIV/krb/RCS/rd_err.c,v $
 * $Author: kfall $
 *
...
"$Header: /usr/src/kerberosIV/krb/RCS/rd_err.c,v 4.6 90/06/25 20:57:10 kfall Exp $";
#endif /* lint */
    ...
    MSG_DAT *m_data;
{
    ...
    /* safely get code */
    memcpy((char *)code, (char *)p,sizeof(*code));
    if (swap_bytes)
        swap_u_long(*code);
