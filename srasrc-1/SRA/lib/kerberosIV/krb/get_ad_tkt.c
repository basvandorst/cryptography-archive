/*
 * $Source: /usr/src/kerberosIV/krb/RCS/get_ad_tkt.c,v $
 * $Author: kfall $
 *
...
"$Header: /usr/src/kerberosIV/krb/RCS/get_ad_tkt.c,v 4.16 90/06/25 20:55:44 kfall Exp $";
#endif /* lint */
    ...
    int     lifetime;
{
    ...
    *(pkt->dat+(pkt->length)++) = (char) lifetime;
    ...
    memset((char *) cr.session, 0,sizeof(key));
