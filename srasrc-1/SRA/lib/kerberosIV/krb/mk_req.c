/*
 * $Source: /usr/src/kerberosIV/krb/RCS/mk_req.c,v $
 * $Author: kfall $
 *
...
"$Header: /usr/src/kerberosIV/krb/RCS/mk_req.c,v 4.18 90/06/25 20:56:56 kfall Exp $";
#endif /* lint */
    ...
    long    checksum;           /* Checksum of data (optional) */
{
    ...
    *(req_id->dat+(req_id->length)++) =
    ...
    memcpy((char *)(authent->dat+authent->length),
          (char *)(req_id->dat), req_id->length);
