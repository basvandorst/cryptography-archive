	...
	{	if (hkey != NULL)
		...
		{	if (guesses!=3)	/* not first guess of null password? */
			...
			{	fprintf(pgpout,PSTR("\nYou need a pass phrase to unlock your RSA secret key. "));
				...
				/* Save off this password for future passes.
				 * don't worry -- key signing will DTRT and
				 * not accept this for multiple key siginings
				 *
				 * This should PROBABLY be stored, internally,
				 * as a hashed pass phrase, but thats not how
				 * its done anyways...  sigh.
				 *
				 * Derek Atkins <warlord@MIT.EDU> 93-02-25
				 */
				strncpy(password, passphrase, sizeof(password) - 1);
