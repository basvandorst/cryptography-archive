...
ORIGIN = MSVCNT
ORIGIN_VER = 1.00
PROJPATH = C:\CIP\RIPEM\RSAREF\INSTALL\ 
USEMFC = 0
CC = cl
CPP = cl
CXX = cl
...
FIRSTCPP = 
RC = rc
CFLAGS_D_LIB32 = /nologo /Za /W3 /Z7 /YX /D "_DEBUG" /D "_X86_" /D "_WINDOWS" /FR /ML /Fp"RSAREFNT.PCH"
CFLAGS_R_LIB32 = /nologo /Za /W3 /YX /O2 /Op- /D "NDEBUG" /D "_X86_" /D "_WINDOWS" /FR /ML /Fp"RSAREFNT.PCH"
...
NN_DEP =  \
	...
	c:\cip\ripem\rsaref\source\nn.h \
	c:\cip\ripem\rsaref\source\digit.h \
	c:\cip\ripem\rsaref\source\longlong.h
...
R_DH.OBJ:	..\SOURCE\R_DH.C $(R_DH_DEP)
	$(CC) $(CFLAGS) $(CUSEPCHFLAG) /c ..\SOURCE\R_DH.C
...
$(PROJ).LIB:	DESC.OBJ DIGIT.OBJ MD2C.OBJ MD5C.OBJ NN.OBJ PRIME.OBJ R_DH.OBJ R_ENCODE.OBJ \
