void find_roots(vector&, cvector&, ivector&, int);

/*
find_roots(vector&, cvector&, ivector&, int)

     You supply the  coefficients of a real monic polynomial as
     a vector p with n components, with p(i), i=0 to n-1,
     equal to the polynomial's x^i coefficient. You designate a cvector
