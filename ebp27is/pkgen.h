/*	pkgen.h - C include file for public-key key generation routines.
...
int keygen(unitptr n,unitptr e,unitptr d,
	unitptr p,unitptr q,unitptr u,unitptr a,unitptr b,short keybits,short ebits);
	/* Generate key components p, q, n, e, d, u, a, and b. */
