...
#pragma map( version_byte,         "EBP00001" )
#pragma map( compress_enabled,     "EBP00002" )
#pragma map( compressSignature,    "EBP00003" )
...
#pragma map( saferCfbDestroy,      "SAFER001" )
#pragma map( saferCfbDecrypt,      "SAFER002" )
#pragma map( saferRandInit,        "SAFER003" )
#pragma map( saferRandByte,        "SAFER004" )
#pragma map( saferRandWash,        "SAFER005" )
#pragma map( saferRandState,       "SAFER006" )
