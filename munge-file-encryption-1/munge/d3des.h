...
#ifdef D2_DES
extern void d1(unsigned char *, unsigned char *);
extern void d2(unsigned char *, unsigned char *);
extern void d3(unsigned char *, unsigned char *);

#define desDkey(a,b)	des2key((a),(b))
#ifndef _AIX
extern void des2key(unsigned char *, int);
#endif
/*		      hexkey[16]     MODE
...
extern void des3key(unsigned char *, int);
/*		      hexkey[24]     MODE
 * Sets the internal key registerS according to the hexadecimal
