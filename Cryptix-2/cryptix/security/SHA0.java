 ...
 * All rights reserved.
 */
public final class SHA0 extends MessageDigest
{
	private static final String LIBRARY_NAME = "sha0";
	private static final String DIGEST_NAME = "SHA0";
	...
	static 
	{
		...
		// implementation of the SHA0 message digest algorithm.
		try
		{
	 ...
	 */
	public static HashSHA0
	hashAsMessageHash( String msg )
	{
		return new HashSHA0( hash( msg, new SHA0() ) );
	}
...
//			dst[dst_off++] = (src[src_off++] << 24) | ((src[src_off++] << 16) & 0xFF0000)
//					| ((src[src_off++] << 8) & 0xFF00) | (src[src_off++] & 0xFF);
...
//					| ((src[src_off++] << 16) & 0xFF0000) | (src[src_off++] << 24);
	...
	throws Exception
	{
		...
		test(out, "a", "37f297772fae4cb1ba39b6cf9cf0381180bd62f2" );
		test(out, "aa", "5173ec2335c575dee032b01562a41330eb803503" );
		test(out, "aaa", "5dfc8a87381aa03e963ab26a645f0fdd60847dfa" );
		test(out, "abc", "0164b8a914cd2a5e74c4f7ff082c4d97f1edf880" );
		test(out, "message digest", "c1b0f222d150ebb9aa36a40cafdc8bcbed830b14" );
		test(out, "abcdefghijklmnopqrstuvwxyz", "b40ce07a430cfd3c033039b9fe9afec95dc1bdcd" );
	}
