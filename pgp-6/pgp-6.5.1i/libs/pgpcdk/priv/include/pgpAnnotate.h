 ...
 *
 * $Id: pgpAnnotate.h,v 1.12 1998/10/08 05:02:17 hal Exp $
 */
...
#define PGPANN_CIPHER_HASHSIZE	0x405
#define PGPANN_CIPHER_HASHDATA	0x406
#define PGPANN_CIPHER_TAILDATA	0x407
#define PGPANN_CIPHER_GOODHASH	0x408
#define PGPANN_CIPHER_BADHASH	0x409
#define PGPANN_CIPHER_NOESK		0x40a
...
/* Data from passthrough for both armor and clearsign */
#define PGPANN_CLEARDATA				0x1302
#define PGPANN_PASSTHROUGH_CLEARSIGN	0x1303
#define PGPANN_PASSTHROUGH_KEYS			0x1304
