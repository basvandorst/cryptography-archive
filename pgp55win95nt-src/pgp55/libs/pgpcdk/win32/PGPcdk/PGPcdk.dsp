...
!MESSAGE 
!MESSAGE NMAKE /f "PGPcdk.mak" CFG="PGPcdk - Win32 Release"
!MESSAGE 
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /machine:I386 /out:".\Release/PGPsdk.dll"
# Begin Custom Build - Creating static library .\Release\PGPsdkstatic.lib
InputPath=.\Release\PGPsdk.dll
SOURCE=$(InputPath)

".\Release\PGPsdkstatic.lib" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	lib /nologo /out:.\Release\PGPsdkstatic.lib .\Release\*.obj .\Release\*.res
...
# ADD CPP /nologo /MTd /W3 /GX /Zi /Od /I "..\..\..\pfl\common\util" /I "..\..\..\pfl\win32" /I "..\..\..\pfl\common" /I "..\..\..\pfl\common\file" /I "..\..\..\pfl\common\prefs" /I ".." /I "..\..\pub\include" /I "..\..\priv\include" /I "..\..\priv\include\opaque" /I "..\..\priv\crypto\bignum" /I "..\..\priv\crypto\cipher" /I "..\..\priv\crypto\compress" /I "..\..\priv\crypto\hash" /I "..\..\priv\crypto\pipe\crypt" /I "..\..\priv\crypto\pipe\file" /I "..\..\priv\crypto\pipe\parser" /I "..\..\priv\crypto\pipe\sig" /I "..\..\priv\crypto\pipe\text" /I "..\..\priv\crypto\pipe\utils" /I "..\..\priv\crypto\random" /I "..\..\priv\debug" /I "..\..\priv\keys\keydb" /I "..\..\priv\keys\keys" /I "..\..\priv\keys\pubkey" /I "..\..\priv\regexp" /I "..\..\priv\utilities\errors" /I "..\..\priv\utilities" /I "..\..\priv\utilities\helper" /I "..\..\priv\utilities\utils" /I "..\..\priv\utilities\prefs" /I "..\..\priv\clientlib" /I "..\..\priv\encrypt" /D UNFINISHED_CODE_ALLOWED=1 /D PGP_DEBUG=1 /D PGP_WIN32=1 /D BNINCLUDE=bni80386c.h /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:".\Debug/PGPsdk.dll"
# Begin Custom Build - Creating static library .\Debug\PGPsdkstatic.lib
InputPath=.\Debug\PGPsdk.dll
SOURCE=$(InputPath)

".\Debug\PGPsdkstatic.lib" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	lib /nologo /out:.\Debug\PGPsdkstatic.lib .\Debug\*.obj .\Debug\*.res
...
SOURCE=..\..\..\pfl\common\pflContext.c
# End Source File
# Begin Source File
...
SOURCE=..\..\priv\keys\keydb\pgpDearmor.c
# End Source File
# Begin Source File
